    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">足球俱乐部管理系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <!--
                            <el-form-item label="教练编号" class="input" v-if="tableName=='jiaolian'">
                                <el-input v-model="ruleForm.jiaolianUuidNumber" autocomplete="off" placeholder="教练编号"  />
                           </el-form-item>
                        -->
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            // jiaolian 中的 教练编号 判空处理
                            // if('jiaolian' == this.tableName && (this.ruleForm.jiaolianUuidNumber== null ||this.ruleForm.jiaolianUuidNumber== "")){
...
<style lang="scss" scoped>
	...
	.container {
		...
		background-image: url(/zuqiujulebguanli/img/back-img-bg.jpg);
