        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.saishiVideo" label="赛事视频" prop="saishiVideo">
                        <file-upload
                            tip="点击上传赛事视频"
                            action="file/upload"
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.saishiVideo?$base.url+ruleForm.saishiVideo:''"
                            @change="saishiVideoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.saishiVideo" label="赛事视频" prop="saishiVideo">
                            <video :src="$base.url+ruleForm.saishiVideo" width="100" height="100" controls="controls">
                            </video>
                        </el-form-item>
                    </div>
                </el-col>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   saishiVideo: [
                              { required: true, message: '赛事视频不能为空', trigger: 'blur' },
                          ],
                   saishiTypes: [
        ...
        methods: {
            ...
            saishiVideoUploadChange(fileUrls){
                this.ruleForm.saishiVideo = fileUrls;
                this.addEditUploadStyleChange()
            },
