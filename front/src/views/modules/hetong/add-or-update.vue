        ...
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.hetongFile" label="上传合同" prop="hetongFile">
                        <file-upload
                                tip="点击上传上传合同"
                                action="file/upload"
                                :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.hetongFile" label="上传合同" prop="hetongFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+ruleForm.hetongFile"  >上传合同下载</a>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="备注" prop="hetongText">
                        <el-input type="textarea"  :readonly="ro.hetongText" v-model="ruleForm.hetongText" placeholder="备注"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.hetongText" label="备注" prop="hetongText">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   hetongFile: [
                              { required: true, message: '上传合同不能为空', trigger: 'blur' },
                          ],
                   hetongText: [
