...
public class SaishiEntity<T> implements Serializable {
     ...
     * 赛事视频
     */
    @ColumnInfo(comment="赛事视频",type="varchar(200)")
    @TableField(value = "saishi_video")

    private String saishiVideo;
    ...
    public void setSaishiVideo(String saishiVideo) {
        this.saishiVideo = saishiVideo;
    }
    /**
	 * 获取：赛事类型
	 */
