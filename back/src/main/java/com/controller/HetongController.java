...
//            hetong.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        ...
        if("".equals(hetong.getHetongText()) || "null".equals(hetong.getHetongText())){
                hetong.setHetongText(null);
        }
...
//                            hetongEntity.setHetongFile(data.get(0));                    //上传合同 要改的
//                            hetongEntity.setHetongText(data.get(0));                    //备注 要改的
