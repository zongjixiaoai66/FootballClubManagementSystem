    ...
    */
    ...
    public R save(@RequestBody SaishiEntity saishi, HttpServletRequest request){
        ...
        Wrapper<SaishiEntity> queryWrapper = new EntityWrapper<SaishiEntity>()
            ...
            .eq("saishi_video", saishi.getSaishiVideo())
...
//            return R.error(511,"永远不会进入");
        ...
        if("".equals(saishi.getSaishiVideo()) || "null".equals(saishi.getSaishiVideo())){
                saishi.setSaishiVideo(null);
        }
        if("".equals(saishi.getSaishiContent()) || "null".equals(saishi.getSaishiContent())){
                saishi.setSaishiContent(null);
        }
...
//                            saishiEntity.setSaishiVideo(data.get(0));                    //赛事视频 要改的
